...
size_t vasprintf(char **ptr, const char *format, va_list ap)
{
    size_t ret;
...
size_t asprintf(char **ptr, const char *format, ...)
{
    va_list ap;
    size_t ret;
...
/**** pts ****/
#ifdef NEED_SPRINTF
size_t sprintf(char *ptr, const char *format, ...)
{
    va_list ap;
    size_t ret;
